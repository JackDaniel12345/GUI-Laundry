...
public class adduser extends javax.swing.JFrame {
    ...
    if(nameField.getText().isEmpty() || emailField.getText().isEmpty() || passwordField.getText().isEmpty()){
        ...
        // 2. If NOT empty, proceed with the database insert
        config conf = new config();

        // SQL for inserting a new user (leaving out u_id for Auto-Increment)
        ...
        // 3. Return to the users list and refresh
        usersForm uf = new usersForm();
        uf.setVisible(true);
        this.dispose();
